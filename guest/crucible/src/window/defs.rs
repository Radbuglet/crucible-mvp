...
#[non_exhaustive]
#[derive(Debug, Clone, Copy, Eq, PartialEq, Hash, Ordinalize)]
#[ordinalize(impl_trait = false)]
#[ordinalize(from_ordinal(pub(super) fn from_winit))]
#[repr(u32)]
pub enum KeyCode {
...
#[non_exhaustive]
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Ordinalize)]
#[ordinalize(impl_trait = false)]
#[ordinalize(from_ordinal(pub(super) const fn from_winit))]
#[repr(u32)]
pub enum NamedKey {
